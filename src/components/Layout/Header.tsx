  ...
  const renderMenuLinks = (itemClassName: string, onItemClick?: () => void) =>
    menuItems.map((item, i) =>
      item.to ? (
        ...
        <a key={i} href={item.href} onClick={onItemClick} className={itemClassName}>
          {item.label}
        </a>
      ),
    );
          ...
          <div className="py-3 flex items-center md:hidden">
            ...
            <h1 className="flex-1 flex flex-col items-center">
              <Link to="/" className="flex flex-col items-center">
                ...
                <img src={headerLogoSrc} alt="親子の時間研究所" className="h-8 w-auto" />
              </Link>
            </h1>
            ...
            {isCondensed ? (
              <div className="flex items-center justify-between py-3 transition-all duration-300">
                <Link to="/" className="flex items-center gap-3">
                  <img src={headerLogoSrc} alt="親子の時間研究所" className="h-10 w-auto" />
                </Link>

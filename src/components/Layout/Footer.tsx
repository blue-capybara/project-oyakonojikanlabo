        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          {showPicoMenu && (
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/pico#salon" className="text-gray-400 hover:text-white">
                    絵本サロン
                  </Link>
                </li>
                <li>
                  <Link to="/pico#kids" className="text-gray-400 hover:text-white">
                    キッズスクール
                  </Link>
                </li>
                <li>
                  <Link to="/culture-school" className="text-gray-400 hover:text-white">
                    カルチャースクール
                  </Link>
                </li>
                <li>
                  <Link to="/pico#rental" className="text-gray-400 hover:text-white">
                    レンタルスペース
                  </Link>
                </li>
                <li>
                  <Link to="/pico#access" className="text-gray-400 hover:text-white">
                    アクセス
                  </Link>
                </li>
              </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/notationbased" className="text-gray-400 hover:text-white">
                  特定商取引法に基づく表記
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          {showOrganizerLoginLinks && (
            <div className="flex justify-center gap-4 mb-4">
              <Link
                to="/event-organizer-login"
                className="inline-flex items-center justify-center text-gray-400 text-sm hover:text-white transition-colors"
              >
          ...
          <p className="text-gray-500">
            &copy; {currentYear} 親子の時間研究所 All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>

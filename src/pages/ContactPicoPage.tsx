        ...
        <div className="container mx-auto px-4">
          <div className="mb-12">
            <div className="flex items-center mb-6">
              <Link to="/pico" className="flex items-center text-gray-600 hover:text-primary transition-colors">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-center mb-4">PICOお問い合わせ窓口</h1>

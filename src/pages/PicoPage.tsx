...
): node is PicoEventNode & { slug: string; title: string } => Boolean(node && node.slug && node.title);
...
const buildLocationLabel = (eventCpt?: PicoEventCpt | null, regions?: PicoEventNode['eventRegions']) => {
...
const transformEventNode = (node: PicoEventNode & { slug: string; title: string }): PicoEventDisplay => {
  ...
  const categorySlug = node.eventCategories?.nodes?.find((item) => item?.slug)?.slug ?? PICO_CATEGORY_SLUG;
  ...
  const slides = [
    {
      ...
      description: "絵本とアートがまじわる場所で、子どもも、大人も、それぞれのたのしみ方を見つけられる。そんな、ちょっとふしぎでたのしい文化のよりどころです。"
    },
    {
    ...
    },
    {
      ...
      title: "カルチャースクール",
      description: "本を読むことって、たのしい。そんな気持ちがすこしずつ育つ、子ども向けのカルチャースクールです。読書がはじめての子も、ちょっと苦手な子も、大歓迎です。"
    },
    {
      image: withBase('images/readdy/9975809614224e2a16b96d2d50b6dadd.png'),
      title: "カルチャースクール（大人向け）",
      description: "大人のための、あそびとまなびの時間です。スクールやサークルをきっかけに、このまちならではの、ちょっといい交流がゆっくり育っていったらいいなと思っています。"
    },
    {
      image: withBase('images/readdy/d8bbaa7384d5faf14bf1facce84ed86d.png'),
      title: "レンタルスペース",
      description: "イベントやワークショップにちょうどいいサイズの空間です。地域のみなさんが気軽につながれる場所として、ひらいています。"
    }
  ];
    ...
    <Layout showNewsletter={false}>
      ...
      <nav className="shadow-sm relative" aria-label="PICO Menu">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="second-nav flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 py-8 md:py-0 md:h-[120px]">
            <img src="https://public.readdy.ai/ai/img_res/fc94a067-c501-4a16-9280-3efc791f4ae6.png" alt="PICO" className="h-16 w-auto" />
            <a href="#about" className="text-gray-700 hover:text-primary group relative px-4 py-2 transition-all duration-300 hover:-translate-y-1">
              <div className="text-center">
                <div className="font-serif text-[14px] group-hover:text-primary">PICOについて</div>
                <div className="text-xs text-gray-500 font-sans group-hover:text-primary/70">About PICO</div>
              </div>
            ...
            <a href="#events" className="text-gray-700 hover:text-primary group relative px-4 py-2 transition-all duration-300 hover:-translate-y-1">
              <div className="text-center">
                <div className="font-serif text-[14px] group-hover:text-primary">イベント</div>
                <div className="text-xs text-gray-500 font-sans group-hover:text-primary/70">Events</div>
              </div>
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></div>
            </a>
            <a href="#instagram" className="text-gray-700 hover:text-primary group relative px-4 py-2 transition-all duration-300 hover:-translate-y-1">
              <div className="text-center">
                <div className="font-serif text-[14px] group-hover:text-primary">インスタグラム</div>
                <div className="text-xs text-gray-500 font-sans group-hover:text-primary/70">Instagram</div>
              </div>
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></div>
            </a>
            {shouldRenderSchoolSection && (
              <a href="#culture-school" className="text-gray-700 hover:text-primary group relative px-4 py-2 transition-all duration-300 hover:-translate-y-1">
                <div className="text-center">
                  <div className="font-serif text-[14px] group-hover:text-primary">カルチャースクール</div>
                  <div className="text-xs text-gray-500 font-sans group-hover:text-primary/70">Culture School</div>
                </div>
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></div>
              </a>
            )}
            {showPicoServiceSections && (
              <a href="#products" className="text-gray-700 hover:text-primary group relative px-4 py-2 transition-all duration-300 hover:-translate-y-1">
                <div className="text-center">
                  <div className="font-serif text-[14px] group-hover:text-primary">商品</div>
                  <div className="text-xs text-gray-500 font-sans group-hover:text-primary/70">Products</div>
                </div>
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></div>
              </a>
            )}
            <a href="#access" className="text-gray-700 hover:text-primary group relative px-4 py-2 transition-all duration-300 hover:-translate-y-1">
              <div className="text-center">
                <div className="font-serif text-[14px] group-hover:text-primary">アクセス</div>
                <div className="text-xs text-gray-500 font-sans group-hover:text-primary/70">Access</div>
              </div>
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></div>
            </a>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
            {picoEventsLoading && !featuredEvent ? (
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 p-8">
                  <div className="flex flex-wrap items-center gap-3 mb-4">
                    <span className={`inline-block px-3 py-1 text-xs rounded-full ${featuredEvent.categoryClassName}`}>
                      {featuredEvent.categoryLabel}
                    </span>
                    <span className={`inline-block px-3 py-1 text-xs rounded-full ${featuredEvent.statusClassName}`}>
              ...
              <div className="p-8 text-center">
                <p className="text-gray-600 mb-2">現在、PICOタグ付きのイベントは公開されていません。</p>
                {picoEventsError && <p className="text-sm text-red-500">エラー: {picoEventsError}</p>}
              </div>
            )}
          </div>
                ...
                {picoEventsLoading && secondaryEvents.length === 0 ? (
                  ...
                  secondaryEvents.map((event) => (
                    <tr key={event.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-4 px-4">
                        <span className={`inline-block px-3 py-1 text-xs rounded-full ${event.categoryClassName}`}>
                          {event.categoryLabel}
                        </span>
                      </td>
                      <td className="py-4 px-4">
                      ...
                      <td className="py-4 px-4">
                        <span className={`inline-block px-3 py-1 text-xs rounded-full ${event.statusClassName}`}>
                          {event.statusLabel}
                        </span>
                      </td>
                    </tr>
                  ...
                  <tr>
                    <td colSpan={5} className="py-8 text-center text-gray-500">
                      {picoEventsError ? (
                        <span>イベント一覧の取得に失敗しました。時間をおいて再度お試しください。</span>
                      ) : (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="flex flex-col md:flex-row">
                <div className="w-full md:w-1/2">
                  <img src={withBase('images/readdy/seq6-squarish-a-beautifully-packaged-monthly-children-s-book.jpg')} alt="絵本の定期購入" className="w-full h-full object-cover" />
                </div>
                <div className="w-full md:w-1/2 p-6 flex flex-col justify-center">
                  <span className="inline-block bg-primary text-white px-3 py-1 text-xs rounded-full mb-3">人気No.1</span>
                  <h3 className="text-xl font-bold mb-3">絵本の定期購入サービス</h3>
                  <p className="text-gray-600 mb-4">毎月、お子さまの年齢に合わせた厳選絵本をお届け。専門スタッフが選書するので、新しい絵本との出会いが広がります。</p>
                  <div className="flex items-center mb-4">
                    <span className="text-2xl font-bold text-primary mr-2">¥2,750</span>
                    <span className="text-sm text-gray-500">(税込)/月</span>
                  </div>
                  <button className="bg-primary text-white px-6 py-3 font-medium rounded-button whitespace-nowrap hover:bg-primary/90 transition-colors">詳細を見る</button>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="flex flex-col md:flex-row">
                <div className="w-full md:w-1/2">
                  <img src={withBase('images/readdy/seq7-squarish-a-premium-children-s-book-subscription-box.jpg')} alt="絵本の定期購入2" className="w-full h-full object-cover" />
                </div>
                <div className="w-full md:w-1/2 p-6 flex flex-col justify-center">
                  <span className="inline-block bg-secondary text-white px-3 py-1 text-xs rounded-full mb-3">0〜3歳向け</span>
                  <h3 className="text-xl font-bold mb-3">赤ちゃん絵本の定期購入</h3>
                  <p className="text-gray-600 mb-4">0〜3歳の発達に合わせた絵本を毎月お届け。丈夫な布絵本や知育要素を含んだ絵本など、成長に寄り添う選書です。</p>
                  <div className="flex items-center mb-4">
            ...
            <div className="overflow-hidden touch-pan-x">
              ...
              >
                <div className="min-w-[280px] bg-white rounded-lg shadow-md overflow-hidden">
                  <img src={withBase('images/readdy/seq8-squarish-a-set-of-colorful-children-s-socks.jpg')} alt="キャラクター靴下" className="w-full h-48 object-cover" />
                  <div className="p-4">
                    <h4 className="font-bold mb-2">キャラクター靴下セット</h4>
                    <p className="text-gray-600 text-sm mb-3">人気絵本キャラクターの靴下3足セット</p>
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-primary">¥1,980</span>
                      <button className="bg-primary text-white px-4 py-2 text-sm rounded-button whitespace-nowrap">カートに入れる</button>
                    </div>
                  </div>
                </div>
                <div className="min-w-[280px] bg-white rounded-lg shadow-md overflow-hidden">
                  <img src={withBase('images/readdy/seq9-squarish-a-children-s-book-tote-bag-with.jpg')} alt="絵本トートバッグ" className="w-full h-48 object-cover" />
                  <div className="p-4">
                    <h4 className="font-bold mb-2">絵本トートバッグ</h4>
                    <p className="text-gray-600 text-sm mb-3">お気に入りの絵本を持ち運べる丈夫なキャンバス地</p>
                    <div className="flex justify-between items-center">
                ...
                <div className="min-w-[280px] bg-white rounded-lg shadow-md overflow-hidden">
                  <img src={withBase('images/readdy/seq10-squarish-a-wooden-puzzle-toy-for-children.jpg')} alt="木製パズル" className="w-full h-48 object-cover" />
                  <div className="p-4">
                    <h4 className="font-bold mb-2">木製パズル「森の動物たち」</h4>
                    <p className="text-gray-600 text-sm mb-3">人気絵本の世界観を再現した木製知育パズル</p>
                    <div className="flex justify-between items-center">
                ...
                <div className="min-w-[280px] bg-white rounded-lg shadow-md overflow-hidden">
                  <img src={withBase('images/readdy/seq11-squarish-a-children-s-art-print-from-a.jpg')} alt="アートプリント" className="w-full h-48 object-cover" />
                  <div className="p-4">
                    <h4 className="font-bold mb-2">絵本アートプリント</h4>
                    <p className="text-gray-600 text-sm mb-3">人気絵本作家の複製原画（額装済み）</p>
                    <div className="flex justify-between items-center">
                ...
                <div className="min-w-[280px] bg-white rounded-lg shadow-md overflow-hidden">
                  <img src={withBase('images/readdy/seq12-squarish-a-children-s-book-with-a-special.jpg')} alt="サイン本" className="w-full h-48 object-cover" />
                  <div className="p-4">
                    <h4 className="font-bold mb-2">「くまくんのぼうけん」サイン本</h4>
                    <p className="text-gray-600 text-sm mb-3">著者・佐藤まりこさん直筆サイン入り限定版</p>
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-primary">¥1,980</span>
                      <button className="bg-primary text-white px-4 py-2 text-sm rounded-button whitespace-nowrap">カートに入れる</button>
                    </div>
      ...
      <section id="instagram" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center mb-8">
            ...
            <a href="https://www.instagram.com/ehon_salon_pico" target="_blank" rel="noopener noreferrer" className="ml-4 text-gray-600 hover:text-primary">
              @ehon_salon_pico
            </a>
          </div>
          <div
            ref={instagramEmbedRef}
            className="juicer-feed-wrapper mt-6"
          >
            <noscript>Instagramフィードを見るにはJavaScriptを有効にしてください。</noscript>
          </div>
          <div className="mt-8 text-center">
            <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-primary hover:underline">
              Instagramでもっと見る
              <div className="w-5 h-5 flex items-center justify-center ml-1">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="flex flex-col md:flex-row">
                <div className="w-full md:w-1/2">
                  <img src={withBase('images/readdy/4d75a49af6fc29ff5c1b0b5c783a3be8.jpeg')} alt="PICO豊中 外観" className="w-full h-full object-cover" />
                </div>
                <div className="w-full md:w-1/2 p-8">
                  <div className="mb-8">
                    <img src={withBase('images/readdy/39e5fc488b56e7ee83d85b9a01bb3b4c.png')} alt="PICO Logo" className="h-24 w-auto mx-auto" />
                  </div>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    1,000冊をこえる絵本や児童書がずらり。<br />
                    えほんにくわしいスタッフがえらんだ本たちを、<br />
                    カフェのなかでゆっくり読むこともできます。
                  </p>
                  <p className="text-lg text-gray-700 leading-relaxed mb-6">
                    店内には、人気作家さんとつくったコラボグッズや、<br />
                    ちょっとめずらしい絵本雑貨もいろいろ。<br />
                    子ども向けのスクール、大人が夢中になるカルチャー講座、<br />
                    地域のイベントがひらけるレンタルルームもあって、<br />
                    たのしみ方はいろいろです。
                  </p>
      ...
      <section id="salon" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            <div>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">絵本にくわしいスタッフがえらんだ、1,000冊以上の絵本と児童書をご用意しています。
              お子さんにぴったりの一冊を、いっしょに探すお手伝いもしています。</p>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">併設のカフェでは、お気に入りの絵本を手に取りながら、フリードリンクでひと息。
              親子でのんびり過ごせる、やわらかな空間づくりをたいせつにしています。</p>
              ...
              <div className="hidden bg-gray-50 rounded-lg p-6">
                ...
                <p className="mt-4 text-sm text-gray-600">※作家コラボのスイーツや季節のスイーツもご用意している場合がございます。（詳しくはInstagramをご確認ください）</p>
              </div>
            </div>
            <div className="space-y-6">
              <img src={withBase('images/readdy/93b794220e208d440430c6f4f6844e28.png')} alt="絵本サロン内観" className="w-full rounded-lg shadow-md" />
              <img src={withBase('images/pico/pico-cafe-menu.png')} alt="カフェメニュー" className="w-full rounded-lg shadow-md" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
              {picoEventsLoading && !featuredSchoolEvent ? (
                ...
                <div className="flex flex-col md:flex-row">
                  <div className="w-full md:w-1/2">
                    <Link to={`/school-detail/${featuredSchoolEvent.slug}`} className="block h-full">
                      <img
                  ...
                  <div className="w-full md:w-1/2 p-8">
                    <div className="flex flex-wrap items-center gap-3 mb-4">
                      <span className={`inline-block px-3 py-1 text-xs rounded-full ${featuredSchoolEvent.categoryClassName}`}>
                        {featuredSchoolEvent.categoryLabel}
                      </span>
                      <span className={`inline-block px-3 py-1 text-xs rounded-full ${featuredSchoolEvent.statusClassName}`}>
                    ...
                    <p className="text-gray-600 mb-6">
                      {featuredSchoolEvent.description || '詳細はスクール詳細ページをご確認ください。'}
                    </p>
                    <div className="space-y-3 mb-6">
                      <div className="flex items-center text-gray-600">
                        <div className="w-5 h-5 flex items-center justify-center mr-2">
                ...
                <div className="p-8 text-center">
                  <p className="text-gray-600 mb-2">現在、PICOタグ付きのスクールは公開されていません。</p>
                  {picoEventsError && <p className="text-sm text-red-500">エラー: {picoEventsError}</p>}
                </div>
              )}
            </div>
                ...
                <tbody>
                  {picoEventsLoading && secondarySchoolEvents.length === 0 ? (
                    ...
                    <tr>
                      <td colSpan={5} className="py-8 text-center text-gray-500">
                        {picoEventsError ? (
                          <span>スクール一覧の取得に失敗しました。時間をおいて再度お試しください。</span>
                        ) : (
      ...
      {showPicoServiceSections && (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            <div>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">「好きなことを、もっと楽しみたい」<br />
              「新しいことにチャレンジしてみたい」<br />
              「自分らしさを、見つけてみたい」</p>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">そんな気持ちを応援する、ちょっとユニークで、なんだか気になる講座やイベントを<br />
              PICOではいろいろひらいています。</p>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">経験なんて、なくても大丈夫。<br />
              思い立ったときに、自分のペースで気軽に参加できます。</p>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">まずは、ふらっと見学にきてみませんか？<br />
              新しい出会いや、思いがけない発見が、きっと待っています。</p>
              <div className="grid grid-cols-3 gap-3">
                {cultureSlides.map((slide, index) => (
                  <div key={index} className="aspect-[3/4.2] rounded-lg overflow-hidden shadow-sm">
                    <img 
                      src={slide} 
            ...
            <div>
              <div id="cultureSlider" className="w-full h-[840px] relative overflow-hidden rounded-lg shadow-md">
                {cultureSlides.map((slide, index) => (
                  <img 
                    key={index}
                    src={slide} 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                ...
                <a href="https://maps.app.goo.gl/sPreNhwogKR3nYRKA" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-primary hover:text-primary/80 transition-colors">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span><a href="tel:06-7654-7069" className="hover:text-primary">TEL: 06-7654-7069</a></span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 flex items-center justify-center text-primary mr-2 mt-0.5">
                      <i className="ri-mail-line"></i>
                    </div>
                    <span><Link to="/contact-pico" className="hover:text-primary">お問い合わせフォーム</Link></span>
                  </li>
                  <li className="flex items-start">
                    <div className="space-y-2">
                      <a href="https://www.instagram.com/culture_bookcafe_pico" target="_blank" rel="noopener noreferrer" className="hover:text-primary flex items-center">
                      ...
                      <a href="https://www.instagram.com/ehon_salon_pico" target="_blank" rel="noopener noreferrer" className="hover:text-primary flex items-center">
                        <div className="w-5 h-5 flex items-center justify-center text-primary mr-1">
                          <i className="ri-instagram-line"></i>
                        </div>
                        @ehon_salon_pico
            ...
            <div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-700 mb-4">〒560-0012 大阪府豊中市上野坂２丁目３−３ エルベラーノ1F</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {galleryItems.map((item, index) => (
              ...
              >
                <img src={item.src} alt={item.alt} className="w-full h-full object-cover transition-transform duration-300 hover:scale-110" />
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden lg:overflow-visible lg:bg-transparent lg:shadow-none">
            <div className="flex flex-col lg:flex-row lg:gap-8">
              <div className="w-full lg:w-1/2 relative min-h-[300px] md:min-h-[500px] lg:bg-white lg:rounded-lg lg:shadow-lg lg:overflow-hidden">
                <div className="relative">
                  <div id="rentalSpaceSlider" className="w-full h-[400px] relative overflow-hidden rounded-lg">
              ...
              <div className="w-full lg:w-1/2 p-4 md:p-8 lg:bg-white lg:rounded-lg lg:shadow-lg relative">
                <div className="absolute inset-0 opacity-10">
                  <img src={withBase('images/readdy/4f76a51c3300c6ee851305a0b7c3e336.png')} alt="Background" className="w-full h-full object-cover" />
                </div>
                <div className="relative z-10">
                  <div className="flex items-center mb-4 md:mb-6">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold">おもしろい人に、ひらかれた場所。はじまります。</h2>
                  </div>
                  <div className="space-y-4 md:space-y-6 lg:space-y-8 text-gray-700">
                    <div className="space-y-3 md:space-y-4 lg:space-y-6 leading-relaxed text-base md:text-lg">
                      ...
                      <p>「作品を見てもらいたい」<br />
                      「だれかと何かやってみたい」<br />
                      「まだかたちにはなってないけど、とにかく動きたい」</p>
                      <p>そんな気持ちを持っている人へ。<br />
                      PICOでは、カフェスペースやお部屋の空いている時間を、お貸ししています。</p>
                      <p>むずかしいルールはありません。<br />
                      やってみたい気持ちがあれば、自分のペースで、どうぞ。</p>
                      <p>設営や告知などはご自身にお願いしていますが、<br />
                      PICOのスタッフも、できるかぎりサポートします。</p>
                      <p>「お店じゃないけど、ちょっとだけ、やってみたい。」<br />
                      そんなあなたに、ちょうどいい場所かもしれません。</p>
                      <p>気になった方は、お気軽に声をかけてくださいね。</p>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4 md:p-6 lg:p-8">
                      <h3 className="font-bold text-base md:text-lg lg:text-xl mb-2 md:mb-3 lg:mb-4">特徴</h3>
                    ...
                    <p className="text-center font-medium">あなたの「おもしろいこと」を、PICOで形にしてみませんか？</p>
      ...
      {activeGalleryModal && (
        ...
        >
          ...
          >
            <img src={galleryImage.src} alt={galleryImage.alt} className="max-w-full max-h-full object-contain" />

...
if ( ! $correct_databases ) :
	?><p class="advads-error-message"><?php _e( "Geo Database not found.", 'advanced-ads-geo' ); ?></p>
	<p><?php _e( "In order to use Geo Targeting, please download the geo location database by clicking on the button below.", 'advanced-ads-geo' ); ?></p><?php
else:
	if( $last_update ) :

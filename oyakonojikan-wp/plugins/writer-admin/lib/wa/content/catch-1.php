...
class WA_Content_Catch_1 extends WA_Content_Abstract {
	public $name = '大見出し';
	...
	public function get_template() {
		ob_start();
		?>
		<script type="application/x-template" id="tmpl-catch-1">
			<div class="editable-content__item">
				...
				<div class="editable-content__body">
					<div class="editable-content__title">
						<div class="editable-content__title-text">大見出し</div>
					...
					<input type="hidden" name="<?php echo WA_Content::get_field_key( true ) ?>[<%= i %>][type]" value="catch-1">
				</div>
			</div>
		</script>
		<?php
